    ...
    return (
        <div className='fixed z-30   w-full bg-white bottom-0'>
            {/* <ul className="flex justify-around p-[12px]">
                ...
                <Link href={'/budgets/analysis'} className={` text-[12px] font-[500] ${currentRoute === '/budgets/analysis' ? ' text-[#66C227]  ' : 'non-active text-[#828282]'}  flex justify-center items-center flex-col max-w-[56px] py-[7px]`}>
                    {currentRoute === '/budgets/analysis' ? <Image className=' size-[24px] ' alt='analysis' width={1000} height={1000} src={status1} /> : <Image className=' size-[24px] ' width={1000} height={1000} alt='track' src={status.src} />}
                    Analysis
                </Link>
                <Link href={'/budgets/analysis'} className={` text-[12px] font-[500] ${currentRoute === '/budgets/analysis' ? ' text-[#66C227]  ' : 'non-active text-[#828282]'}  flex justify-center items-center flex-col max-w-[56px] py-[7px]`}>
                    {currentRoute === '/budgets/analysis' ? <Image className=' size-[24px] ' alt='analysis' width={1000} height={1000} src={profile1.src} /> : <Image className=' size-[24px] ' width={1000} height={1000} alt='track' src={profile} />}
                    Profile
                </Link>
