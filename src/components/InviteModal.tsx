...
import {
  acceptBudgetInviteApi,
  getPendingInvitesApi,
  rejectBudgetInviteApi,
...
//   refetchAllBudgets,
  ...
  const inviterName =
    inviteData?.owner?.firstName + ' ' + inviteData?.owner?.lastName || 'Unknown User';
    ...
    >
      <div className="relative text-center flex rounded-[40px] p-[24px] justify-center items-center flex-col bg-white">
        <div
          ...
          className="absolute top-[19px] right-[19px] size-[28px] bg-[#EFF0F6] rounded-[8px] grid place-content-center"
        >
        ...
        <Image
          ...
          alt="shake"
        />
        <h1 className="mt-[24px] text-[20px] font-[500] leading-[28px]">
        ...
        <div className="mt-[24px] flex items-center gap-[16px]">
          <button
            ...
            className="font-[500] shadow-md bg-[#F7F7F9] rounded-[32px] w-[139px] h-[48px]"
          >
            {rejectInviteMutation.isPending ? 'Declining...' : 'Decline'}
          </button>
          <button
            onClick={() => handleAcceptInvite()}
            className="text-white shadow-md font-[500] bg-[#040404] rounded-[32px] w-[139px] h-[48px]"
          >
