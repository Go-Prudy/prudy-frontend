                ...
                >
                  ...
                  {showRemove === index && (
                    <div className="absolute top-[40px] right-[12px] bg-white p-[8px] rounded-[8px] shadow-lg">
                      <button
                        className="flex gap-[8px] px-[12px] py-[8px] items-center justify-center text-[12px] text-[#575757]"
                        onClick={() => {
                      ...
                      >
                        <div className="bg-[#F5365C] rounded-[4px] text-white flex justify-center items-center gap-[4px] size-[16px]">
                          -
                        </div>
                        Remove
                      </button>
        ...
        >
          <div className=" text-[#707170] rounded-[40px] w-full p-[24px] bg-white">
            <div className=" flex mb-[8px] justify-between  w-full">
              <div></div>
              <h1 className=" text-[#292B31] text-center font-[500] text-[20px] ">
                Remove guest
              </h1>
              <div>
                {' '}
                <button
                  onClick={() => setRemoveGuestModal(!removeGuestModal)}
                  className=" text-[#292A29] rounded-[8px] bg-[#EFF0F6] p-[9px] "
                >
                  <BsX size={20} />
                </button>
              </div>
            ...
            <div className="  mb-[24px] ">
              <h1 className=" text-center">
                ...
                <span className=" text-[#575757] font-[700]">{selectedUser?.name} </span>{' '}
                from your budget?
              </h1>
            </div>
            ...
            <div className=" flex gap-[16px] items-center">
              <button
                ...
                className=" px-[25px] py-[14px] rounded-[32px]  bg-[#F7F7F9] text-[#575757] "
              >
                Yes, remove
              </button>
              <button
                onClick={() => setRemoveGuestModal(!removeGuestModal)}
                className=" py-[14px] px-[59px] bg-[#121212] rounded-[32px] text-white"
              >
                No
              </button>
            </div>
