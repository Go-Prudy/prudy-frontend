...
const Page = () => {
  ...
  const {
    data: getAllCurrenciesData = [],
    status: getAllCurrenciesStatus,
    isPending: getAllCurrenciesIsPending,
  } = useQuery({
  ...
  const SetCurrencyApiMutation = useMutation({
    mutationFn: (data: any) => SetCurrencyApi(authenticatedUser?.token ?? '', data),
    onSuccess: (data) => {
      console.log(data);
    },
      ...
      <div className=" px-[24px]">
        <div className=" bg-[#F7F7F9] mt-[16px]  p-[8px] rounded-[12px]  border flex gap-[8px] border-[#EFEFF0] ">
          <button
            ...
            className={`${!currentState ? 'bg-white' : 'bg-none'} text-center w-full py-[8px] rounded-[8px] `}
          >
            Currency
          </button>
        ...
        {currentState === false && (
          <>
            <h1 className=" font-[500] text-[20px] mt-[16px]">
            ...
            <div className=" mt-[24px] w-full bg-[#F7F7F9] p-[16px] rounded-[24px] border-[#EFEFF0] border">
              <div className=" text-[#828282] w-full flex justify-between">
                ...
                <button
                  onClick={() => setShowAllCurrency(true)}
                  className=" bg-white rounded-[10px] text-[#828282] px-[8px] text-[12px] py-[4px]  "
                >
                  change
                </button>
              </div>
              <div className="flex items-center gap-2">
                <div className=" w-[24px] rounded-full  h-[24px] ">
                  <Image
                    src={getSettingsData?.countryFlag || ''}
                    width={1000}
                    height={1000}
                    className=" size-[24px] mb-[8px]"
                    alt=""
                  />
                </div>
                <h1 className=" font-[500] text-[14px] ">
                  {getSettingsData?.currency || 'NGN'}
                </h1>
              </div>
            </div>
          </>
        ...
        {currentState === true && (
          <>
            ...
            <div className=" mt-[24px] w-full bg-[#F7F7F9] p-[16px] rounded-[24px] border-[#EFEFF0] border">
              ...
              <h1 className=" text-[#828282] text-[14px] leading-[17px] mt-[8px] mb-[16px] ">
                Share transaction data with linked bank accounts for real-time updates.
              </h1>
              <div className=" font-[700] text-[12px] text-[#828282]">
                <h1>
                  Last Synced: <span className="">Sept 15, 2024</span>
                </h1>
              </div>
            </div>
            ...
            <div className=" mt-[24px] w-full bg-[#F7F7F9] p-[16px] rounded-[24px] border-[#EFEFF0] border">
              ...
              <button
                ...
                className=" bg-[#F7DAE0] w-full py-[12px] rounded-[32px] text-[14px] text-center text-[#F5365C]  "
              >
                Refresh
              </button>
            </div>
            ...
            <div className=" mt-[24px] w-full bg-[#F7F7F9] p-[16px] rounded-[24px] border-[#EFEFF0] border">
              ...
              <h1 className=" text-[#828282] text-[14px] leading-[17px] mt-[8px] mb-[16px] ">
                Delete my profile and all associated data
              </h1>
              <button
                onClick={() => {
                  setShowAfresh(false);
            ...
            <div>
              <h1 className=" font-[500] text-[#828282] mt-[20px] text-[14px]">
                Kindly note that customers data are only used for the purpose of improving
                their budgeting experience and no other purpose.
                <span className=" mt-[16px] block mb-[24px] ">
                  See our{' '}
                  <Link className=" text-[#66C227]" href={'/terms&condition'}>
          ...
          >
            ...
            >
              ...
              <p className="text-[#707170] leading-[24px]">
                Are you sure you want to delete your data on this app? You won’t be able
                to recover your profile data again after doing this
              </p>
        ...
        {showAfreshModal && (
          ...
          >
            ...
            >
              ...
              <p className="text-[#707170] leading-[24px]">
                Are you sure you want to refresh your data on this application? This will
                reset as though you’re a new user
              </p>
              ...
              <div className="flex w-full flex-wrap">
                <ul className=" h-[30vh] w-full overflow-y-scroll overflow-x-hidden">
                  {!getAllCurrenciesIsPending ? (
                    <>
                      {getAllCurrenciesData?.map(
                        (currency: ICurrencyData, index: number) => (
                          <li
                            key={currency?.countryCode}
                            className={`flex w-full items-center text-[14px] text-[#575757] leading-[28px] mb-4 ${
                              index !== getAllCurrenciesData?.length - 1
                                ? 'border-b border-b-[#F7F7F9]'
                                : ''
                            }`}
