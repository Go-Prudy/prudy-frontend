    ...
    >
        ...
        <div className="">
            ...
            <div className=" bg-[#FFFFFF] mt-[12px] p-[12px] rounded-[12px] ">
              {features.map((feature, index) => (
                <div key={index} className="flex items-center mb-[12px] last:mb-0">
                  ...
                  <span className="ml-[12px] text-[#575757] leading-[28px] text-base">
                    {feature}
                  </span>
                </div>
              ))}
          ...
          <div>
            <button
              ...
              className=" text-center z-[2] relative w-full my-[24px]  text-[#FAFAFA] flex items-center justify-center gap-[5px] font-[500]"
            >
      ...
      {showSuccessfullPayment && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          transition={{ duration: 0.3 }}
          className="h-[100vh] w-full z-[40] bottom-0 max-w-[500px] fixed bg-[#1c1c1c73]"
        >
          <DeleteSuccessModal
