...
const Page = () => {
  ...
  return (
    <motion.div
      ...
      <div
        className="sticky bottom-0 flex w-full items-center bg-white px-6 py-6 rounded-t-3xl"
        style={{ boxShadow: '0px -4px 4px 0px #EFF0F680' }}
      >
        <button
          type="button"
          className="h-12 flex font-[500] gap-[8px] items-center justify-center  text-white bg-black rounded-3xl w-full"
          onClick={handleProceedClick}
        >
          {loading ? (
            <div className="h-12 flex font-[500] gap-[8px] items-center justify-center  text-white bg-black rounded-3xl w-full ">
              Proceeding...
            </div>
          ) : (
            'Proceed'
