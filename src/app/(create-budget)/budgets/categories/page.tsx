    ...
    <div className="  w-[100vw] max-w-[500px] relative h-screen">
      ...
      >
        <motion.div className=" relative">
          ...
          <h1 className=" mt-[18px] mb-[14px] ml-[24px] text-[16px] font-[500]">
            All Categories
          </h1>
        ...
        >
          ...
          >
            <div onClick={(e) => e.stopPropagation()} className=" my-[24px] w-full">
              <div className="flex justify-between w-full items-center p-[12px] bg-[#F7F7F9] rounded-[12px]  border-[1px] border-[#EFEFF0] ">
                {/* Category Name */}
