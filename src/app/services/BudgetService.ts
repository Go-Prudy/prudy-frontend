...
export const RecordExpenseApi = async (
  budgetId: string,
  ...
  try {
    const response = await api.post(
      `budgets/${budgetId}/categories/${budgetCategoryId}/expenses`,
      data,
      {
        headers: {
          Authorization: `Bearer ${token}`, // Include the token in the Authorization header
...
export const inviteCollaboratorApi = async (
  token: string,
  budgetId: string,
