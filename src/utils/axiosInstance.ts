...
const api = axios.create({
  baseURL:
    process.env.REACT_APP_API_URL || 'https://prudy-api-staging.up.railway.app/api/v1', // Default to production API
  // baseURL: 'http://localhost:8080/api/v1', // Default to local API
  headers: {
